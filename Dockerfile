...
LABEL org.opencontainers.image.authors="lalexdotcom" \
	org.opencontainers.image.title="MariaDB" \
	org.opencontainers.image.description="Debian 10 Buster with MariaDB 10.3 (works on arm arch), forked from Tobias Hargesheimer" \
...
ENV USER_ID 1000
ENV GROUP_ID 1000
RUN groupadd -g $GROUP_ID mysql && useradd -u $USER_ID -g mysql mysql
